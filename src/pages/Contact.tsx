        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="md:col-span-12 lg:col-span-7">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 hidden lg:block">Send us a message</h2>
              <ContactForm />
            </div>
            ...
            <div className="md:col-span-12 lg:col-span-5 space-y-8">
              ...
              <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                <h3 className="font-bold text-lg text-nayaysetu mb-6">What happens after you contact us:</h3>
                <div className="space-y-6">
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      <p className="font-medium text-gray-900">We review your message</p>
                      <p className="text-sm text-gray-600">Our legal team reviews your details within 24 hours.</p>
                    </div>
                  </div>
              ...
              {/* Contact Details */}
              <div className="bg-nayaysetu p-8 rounded-xl text-white shadow-lg">
                <h3 className="text-xl font-bold mb-6 text-white border-b border-white/20 pb-4">Contact Information</h3>

                <div className="space-y-6">
                  <a href="tel:+918302553346" className="flex items-start group transition-opacity hover:opacity-90">
                    <div className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center text-nayaysetu-gold flex-shrink-0">
                  ...
                  <div className="flex items-start pt-4 border-t border-white/10">
                    <div className="w-10 h-10 flex items-center justify-center text-nayaysetu-gold flex-shrink-0">
